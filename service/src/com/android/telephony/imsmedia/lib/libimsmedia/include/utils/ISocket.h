...
public:
    ...
    virtual bool Listen(ISocketListener* pListener) = 0;
    ...
    virtual bool ConvertIPStrToBin(char* pszSourceIP, char* pszDestBin, eIPVersion eIPver) = 0;
    virtual void Close(eSocketMode mode) = 0;
