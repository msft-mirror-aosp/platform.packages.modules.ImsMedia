 ...
 * Side Effects            : None
 ********************************************************/
eRTP_STATUS_CODE RtcpSrPacket::decodeSrPacket(IN RtpDt_UChar *pucSrPktBuf,
                           IN RtpDt_UInt16 usSrPktLen,
...
*/
    ...
    {
        RTP_TRACE_WARNING("RtcpPacket::decodeRtcpPacket, RR pkt Decoding Error ...!",
                RTP_ZERO,RTP_ZERO);
        return eDecodeRes;
    }
...
block  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  2    :                               ...                             :
    ...
    *(RtpDt_UInt32*)pucBuffer = RtpOsUtil::Ntohl(m_uiSendOctCount);
    ...
    {
        RTP_TRACE_WARNING("RtcpPacket::formSrPacket, Report Block Encoding Error ...!",
                RTP_ZERO,RTP_ZERO);
        return eEncodeRes;
    }
